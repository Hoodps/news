...
function(t) {
	function e(t, e) {
		...
		if (!(c in a)) {
			...
			l.type = "text/javascript", l.src = c, n.appendChild(l)
		}
	}
...
}(this), define("zepto", function(t, e, n) {
	!
	function(t) {
	...
	var i = function() {
			...
			function l(t) {
				var e, n;
				return P[t] || (e = C.createElement(t), C.body.appendChild(e), n = A(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), P[t] = n), P[t]
			}
			function h(t, e, i) {
			...
			return B.matches = function(t, e) {
				...
				var i, r = t.parentNode,
					o = !r;
				return o && (r = $).appendChild(t), i = ~B.qsa(r, e).indexOf(t), o && $.removeChild(t), i
			}, b = function(t) {
				...
				e === v && (e = j.test(t) && RegExp.$1), e in X || (e = "*");
				var n = X[e];
				return n.innerHTML = "" + t, y.each(T.call(n.childNodes), function() {
					n.removeChild(this)
				})
			}, B.Z = function(t, e) {
				return t = t || [], N ? y.extend(t, y.fn) : t.__proto__ = arguments.callee.prototype, t.selector = e || "", t.isZ = !0, t
			}, B.isZ = function(t) {
				return t.isZ
			}, B.init = function(e, r) {
				if (e) {
					...
					var a;
					if (i(e)) a = o(e);
					else if (n(e)) a = [y.extend({}, e)], e = null;
					else if (D.indexOf(e.nodeType) >= 0 || e === window) a = [e], e = null;
					else if (j.test(e)) a = B.fragment(e.trim(), RegExp.$1), e = null;
					else {
			...
			}, y.isFunction = t, y.isObject = e, y.isArray = i, y.isPlainObject = n, y.isWp = N, y.inArray = function(t, e, n) {
				return E.indexOf.call(e, t, n)
			}, y.trim = function(t) {
				return t.trim()
			}, y.uuid = 0, y.map = function(t, e) {
				var n, i, o, s = [];
				if (r(t)) for (i = 0; i < t.length; i++) n = e(t[i], i), null != n && s.push(n);
				else for (o in t) n = e(t[o], o), null != n && s.push(n);
				return a(s)
			}, y.each = function(t, e) {
				var n, i;
				if (r(t)) {
				...
				concat: E.concat,
				map: function(t) {
					return y.map(this, function(e, n) {
						return t.call(e, n, e)
					})
				},
				slice: function() {
				...
				ready: function(t) {
					return !Y.test(C.readyState) || N && "interactive" == C.readyState ? C.addEventListener("DOMContentLoaded", function() {
						t(y)
					}, !1) : t(y), this
				},
				get: function(t) {
				...
				filter: function(t) {
					return y([].filter.call(this, function(e) {
				...
				parents: function(t) {
					for (var e = [], n = this; n.length > 0;) n = y.map(n, function(t) {
				...
				show: function() {
					return this.each(function() {
						"none" == this.style.display && (this.style.display = ""), "none" == A(this, "").getPropertyValue("display") && (this.style.display = l(this.nodeName))
					})
				},
				...
				wrapAll: function(t) {
					return this[0] && (y(this[0]).before(t = y(t)), t.append(this)), this
				},
				unwrap: function() {
				...
				offset: function() {
					var t = function(e) {
							...
							function(t) {
								...
								for (var e = t.offsetTop, n = t.offsetLeft, i = t.offsetWidth, r = t.offsetHeight; t.offsetParent;) t = t.offsetParent, e += t.offsetTop, n += t.offsetLeft;
								return e -= window.pageYOffset, n -= window.pageXOffset, {
									top: e,
									left: n,
									right: n + i,
									bottom: e + r,
				...
				css: function(t, e) {
					...
					}) : n = s(t) + ":" + c(t, e)), this.each(function() {
				...
				toggleClass: function(t, e) {
					return this.each(function(n) {
						var i = p(this, t, n, this.className);
						(e === v ? !y(this).hasClass(i) : e) ? y(this).addClass(i) : y(this).removeClass(i)
					})
				}
				...
				y.fn[t] = function() {
					var t = y.map(arguments, function(t) {
					...
					return this.each(function(e, a) {
						for (var s = 0; s < t.length; s++) {
							...
							}), r && i - 1 > e && (u = u.cloneNode(!0)), d(n, a, u)
						}
					})
				}, y.fn[n % 2 ? t + "To" : "insert" + (n ? "Before" : "After")] = function(e) {
					return y(e)[t](this), this
				}
			}), B.Z.prototype = y.fn, B.camelize = b, B.uniq = x, y.zepto = B, y
		}();
	window.Zepto = i, "$" in window || (window.$ = i), function(t) {
		...
		function s(t, i, r, a) {
			...
			o(i || "", r, function(e, i) {
				n(t, e, i, a).forEach(function(e) {
					delete l[s][e.i], t.removeEventListener(e.e, e.proxy, !1)
				})
			})
		}
		function u(e) {
			...
			return t.each(m, function(t, i) {
				n[t] = function() {
					return this[i] = p, e[t].apply(e, arguments)
				}, n[i] = d
			}), n
		}
		function c(e) {
			if (!("defaultPrevented" in e) || t.isWp) {
				...
				e.preventDefault = function() {
					this.defaultPrevented = !0, this.defaultPrevented || (this.ieDefaultPrevented = !0), n.call(this)
				}
			}
		}
		var l = (t.zepto.qsa, {}),
		...
		t.fn.delegate = function(e, n, i) {
			var r = !1;
			return ("blur" == n || "focus" == n) && (t.iswebkit ? n = "blur" == n ? "focusout" : "focus" == n ? "focusin" : n : r = !0), this.each(function(o, s) {
				a(s, n, i, e, function(n) {
					return function(i) {
			...
			return this.each(function(a, s) {
				r = u("string" == typeof e ? t.Event(e) : e), r.data = i, r.target = s, t.each(t(this).add(t(this).parents()).add(document), function(i, a) {
					return t.each(n(a, e.type || e), function(t, e) {
						return o = e.proxy(r), r.isDefaultPrevented && (r.defaultPrevented = !0), r.isImmediatePropagationStopped() ? !1 : void 0
			...
			var r, o;
			return this.each(function(a, s) {
				r = u("string" == typeof e ? t.Event(e) : e), r.data = i, r.target = s, t.each(n(s, e.type || e), function(t, e) {
			...
			return n.initEvent(t, i, !0, null, null, null, null, null, null, null, null, null, null, null, null), c(n), n
		}
	}(i), function(t) {
		function e(t) {
			var e = this.os = {},
			...
			(n.webkit = !! i) && (n.version = i[1]), r && (e.android = !0, e.version = r[2]), a && (e.ios = e.iphone = !0, e.version = a[2].replace(/_/g, ".")), o && (e.ios = e.ipad = !0, e.version = o[2].replace(/_/g, ".")), s && (e.webos = !0, e.version = s[2]), u && (e.touchpad = !0), h && (e.blackberry = !0, e.version = h[2]), c && (e.kindle = !0, e.version = c[1]), l && (n.silk = !0, n.version = l[1]), !l && e.android && t.match(/Kindle Fire/) && (n.silk = !0)
		}
		...
		t.each(a, function(t, i) {
			...
			return t.isObject(n) && (i = n.easing, r = n.complete, n = n.duration), n && (n /= 1e3), this.anim(e, n, i, r)
		}, t.fn.anim = function(n, i, r, a) {
			var s, u, h, f = {},
				p = this,
				d = t.fx.transitionEnd;
			if (i === e && (i = .4), t.fx.off && (i = 0), "string" == typeof n) f[o + "animation-name"] = n, f[o + "animation-duration"] = i + "s", d = t.fx.animationEnd;
			else {
				for (u in n) c.test(u) ? (s || (s = []), s.push(u + "(" + n[u] + ")"), delete n[u]) : f[u] = n[u];
				s && (f[o + "transform"] = s.join(" "), n.transform = "transform"), t.fx.off || "object" != typeof n || (f[o + "transition-property"] = Object.keys(n).join(", "), f[o + "transition-duration"] = i + "s", f[o + "transition-timing-function"] = r || "linear")
			}
			return h = function(e) {
			...
			}, i > 0 && this.bind(d, h), setTimeout(function() {
				p.css(f), 0 >= i && setTimeout(function() {
					p.each(function() {
						h.call(this)
					})
				}, 0)
		...
		function e(e, n, i) {
			var r = t.Event(n);
			return t(e).trigger(r, i), void 0 !== r.ieDefaultPrevented ? !r.ieDefaultPrevented : !r.defaultPrevented
		}
		function n(t, n, i, r) {
		...
		function f(e) {
			g(e.data) && (e.data = t.param(e.data)), !e.data || e.type && "GET" != e.type.toUpperCase() || (e.url = h(e.url, e.data))
		}
		function p(e, n, i, r) {
			var o = t.isArray(n);
			t.each(n, function(n, a) {
				r && (n = i ? r : r + "[" + (o ? "" : n) + "]"), !r && o ? e.add(a.name, a.value) : (i ? t.isArray(a) : g(a)) ? p(e, a, i, n) : e.add(n, a)
			})
		}
		var d, m, v = 0,
			g = t.isObject,
		...
		t.active = 0, t.ajaxJSONP = function(e) {
			var n, i = "jsonp" + ++v,
				...
				o = function() {
					t(r).remove(), i in window && (window[i] = c), u("abort", s, e)
				},
				s = {
					abort: o
				};
			return e.error && (r.onerror = function() {
				...
				clearTimeout(n), t(r).remove(), delete window[i], a(o, s, e)
			}, f(e), r.src = e.url.replace(/=\?/, "=" + i), t("head").append(r), e.timeout > 0 && (n = setTimeout(function() {
				s.abort(), u("timeout", s, e)
			}, e.timeout)), s
		}, t.ajaxSettings = {
			type: "GET",
			beforeSend: c,
			...
			var r = n.dataType,
				u = /=\?/.test(n.url);
			if ("jsonp" == r || u) return u || (n.url = h(n.url, "callback=?")), t.ajaxJSONP(n);
			n.url || (n.url = window.location.toString()), f(n);
			var p, v = n.accepts[r],
				g = {},
				y = /^([\w-]+:)\/\//.test(n.url) ? RegExp.$1 : window.location.protocol,
				w = t.ajaxSettings.xhr();
			n.crossDomain || (g["X-Requested-With"] = "XMLHttpRequest"), v && (g.Accept = v, v.indexOf(",") > -1 && (v = v.split(",", 2)[0]), w.overrideMimeType && w.overrideMimeType(v)), (n.contentType || n.data && "GET" != n.type.toUpperCase()) && (g["Content-Type"] = n.contentType || "application/x-www-form-urlencoded"), n.headers = t.extend(g, n.headers || {}), w.onreadystatechange = function() {
				if (4 == w.readyState) {
					clearTimeout(p);
					var t, e = !1;
			...
			return o(w, n) === !1 ? (w.abort(), !1) : (n.timeout > 0 && (p = setTimeout(function() {
				w.onreadystatechange = c, w.abort(), s(null, "timeout", w, n)
			...
			var i, r = this,
				o = e.split(/\s/);
			return o.length > 1 && (e = o[0], i = o[1]), t.get(e, function(e) {
				r.html(i ? t(y.createElement("div")).html(e.replace(w, "")).find(i).html() : e), n && n.call(r)
			}), this
		};
		...
		function i() {
			a = null, s.last && (s.el.trigger("longTap"), s = {})
		}
		function r() {
		...
		t(document).ready(function() {
			...
			t(document.body).bind("touchstart", function(n) {
				c = Date.now(), l = c - (s.last || c), s.el = t(e(n.touches[0].target)), o && clearTimeout(o), s.x1 = n.touches[0].pageX, s.y1 = n.touches[0].pageY, l > 0 && 250 >= l && (s.isDoubleTap = !0), s.last = c, a = setTimeout(i, u)
			}).bind("touchmove", function(t) {
				r(), s.x2 = t.touches[0].pageX, s.y2 = t.touches[0].pageY
			}).bind("touchend", function() {
				r(), s.isDoubleTap ? (s.el.trigger("doubleTap"), s = {}) : s.x2 && Math.abs(s.x1 - s.x2) > 30 || s.y2 && Math.abs(s.y1 - s.y2) > 30 ? (s.el.trigger("swipe") && s.el.trigger("swipe" + n(s.x1, s.x2, s.y1, s.y2)), s = {}) : "last" in s && (s.el.trigger("tap"), o = setTimeout(function() {
					o = null, s.el.trigger("singleTap"), s = {}
				}, 250))
			}).bind("touchcancel", function() {
				o && clearTimeout(o), a && clearTimeout(a), a = o = null, s = {}
			})
...
function(t) {
	...
	t.fn.fullPage = function(e) {
		function n() {
			s.on("touchstart", function(t) {
				...
				var e = t.changedTouches[0].pageY - p,
					...
					o = f;
				f = i(f + n), r(f, o, !0)
			}), a.drag && s.on("touchmove", function(t) {
				if (d) return 0;
				t.preventDefault();
				var e = t.changedTouches[0].pageY - p;
		...
		function r(t, e, n) {
			n ? (s.addClass("anim"), d = !0) : s.removeClass("anim"), s.css("top", -t * h + "px"), window.setTimeout(function() {
				d = !1, t !== e && (a.onchange({
					cur: t
		...
		function o() {
			h = u.height(), c.height(h), r(f, -1, !1), n()
		}
		var a = {
			page: ".page",
			start: 0,
...
function(t, e, n) {
	...
	function i(t, e) {
		...
		this.extend(this, a, e, n), this.calibrationTimer = null, this.calibrationFlag = !0, this.enabled = !1, this.depths = [], this.raf = null, this.ox = 0, this.oy = 0, this.ow = 0, this.oh = 0, this.cx = 0, this.cy = 0, this.ix = 0, this.iy = 0, this.mx = 0, this.my = 0, this.vx = 0, this.vy = 0, this.onMouseMove = this.onMouseMove.bind(this), this.onDeviceOrientation = this.onDeviceOrientation.bind(this), this.onOrientationTimer = this.onOrientationTimer.bind(this), this.onCalibrationTimer = this.onCalibrationTimer.bind(this), this.onAnimationFrame = this.onAnimationFrame.bind(this), this.onWindowResize = this.onWindowResize.bind(this), this.initialise()
	}
	var r = "Parallax",
		o = 30,
		a = {
	...
	i.prototype.extend = function() {
		...
		for (var n, i, r = 0, o = 0; t && !isNaN(t.offsetLeft) && !isNaN(t.offsetTop);) t === e.body ? (n = e.documentElement.scrollLeft, i = e.documentElement.scrollTop) : (n = t.scrollLeft, i = t.scrollTop), r += t.offsetLeft - n, o += t.offsetTop - i, t = t.offsetParent;
		return {
			top: o,
			left: r
		}
		...
		return s
	}, i.prototype.ww = null, i.prototype.wh = null, i.prototype.hw = null, i.prototype.hh = null, i.prototype.portrait = null, i.prototype.desktop = !navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|mobi|tablet|opera mini|nexus 7)/i), i.prototype.vendors = [null, ["-webkit-", "webkit"],
		["-moz-", "Moz"],
		["-o-", "O"],
		["-ms-", "ms"]
	], i.prototype.motionSupport = !! t.DeviceMotionEvent, i.prototype.orientationSupport = !! t.DeviceOrientationEvent, i.prototype.orientationStatus = 0, i.prototype.transform2DSupport = i.prototype.transformSupport("2D"), i.prototype.transform3DSupport = i.prototype.transformSupport("3D"), i.prototype.initialise = function() {
		...
		for (var n = 0, i = this.layers.length; i > n; n++) {
			var r = this.layers[n];
			this.transform3DSupport && this.accelerate(r), r.style.position = n ? "absolute" : "relative", r.style.display = "block", r.style.height = "100%", r.style.width = "100%", r.style.left = 0, r.style.top = 0, this.depths.push(this.data(r, "depth") || 0)
		}
		...
		for (var r = null, o = 0, a = this.vendors.length; a > o; o++) if (r = null !== this.vendors[o] ? this.camelCase(this.vendors[o][1] + "-" + e) : e, t.style[r] !== n) {
			t.style[r] = i;
			break
		}
	}, i.prototype.accelerate = function(t) {
		this.css(t, "transform", "translate3d(0,0,0)"), this.css(t, "backface-visibility", "hidden")
	}, i.prototype.setPosition = function(t, e, n) {
		e += "%", n += "%", this.transform3DSupport ? this.css(t, "transform", "translate3d(" + e + "," + n + ",0)") : this.transform2DSupport ? this.css(t, "transform", "translate(" + e + "," + n + ")") : (t.style.left = e, t.style.top = n)
		...
		var t = this.ix - this.cx,
			e = this.iy - this.cy;
		(Math.abs(t) > this.calibrationThreshold || Math.abs(e) > this.calibrationThreshold) && this.queueCalibration(0), this.portrait ? (this.mx = (this.calibrateX ? e : this.iy) * this.scalarX, this.my = (this.calibrateY ? t : this.ix) * this.scalarY) : (this.mx = (this.calibrateX ? t : this.ix) * this.scalarX, this.my = (this.calibrateY ? e : this.iy) * this.scalarY), isNaN(parseFloat(this.limitX)) || (this.mx = this.clamp(this.mx, -this.limitX, this.limitX)), isNaN(parseFloat(this.limitY)) || (this.my = this.clamp(this.my, -this.limitY, this.limitY)), this.vx += (this.mx - this.vx) * this.frictionX, this.vy += (this.my - this.vy) * this.frictionY;
		for (var n = 0, i = this.layers.length; i > n; n++) {
			var r = this.layers[n],
				o = this.depths[n],
	...
	function n(t) {
		o();
		for (var n = 0, r = v.length; r > n; n++) n !== t && (v[n].pause(), c(".audio").eq(n).removeClass("play"));
		return d !== t ? (g[t] || e(v[t], m[t]), v[t].play(), c(".audio").eq(t).addClass("play"), d = t, 0) : void i(t)
	}
	function i(t) {
		d = -1, v[t].pause(), c(".audio").eq(t).removeClass("play")
	}
	function r() {
		return y ? 0 : (w || e(l, "bg.mp3"), l.play(), y = !0, c("#music-btn").addClass("play"), void c("#music-text").text("开启"))
	}
	function o() {
		l.pause(), y = !1, c("#music-btn").removeClass("play"), c("#music-text").text("关闭")
	}
	function a() {
		c("body").one("touchstart", function() {
			e(l, "bg.mp3"), e(h, "nv1.mp3"), e(p, "nv2.mp3"), e(f, "nan.mp3")
		}), c("#music").on("touchstart", function(t) {
			return t.stopPropagation(), y ? (o(), 0) : (r(), 1)
		}), c("#download").on("tap", function() {
	...
	function u() {
		c("#wp-inner").fullPage({
			start: 0,
			onchange: function(t) {
				return 4 !== t.cur && (i(0), i(1), i(2)), 2 === t.cur ? (c(".score").html("0"), window.setTimeout(function() {
		...
		}), new Parallax(document.getElementById("page1-scene")), new Parallax(document.getElementById("page2-scene")), new Parallax(document.getElementById("page3-scene")), new Parallax(document.getElementById("page4-scene")), new Parallax(document.getElementById("page5-scene")), a()
	}
	var c = t("zepto"),
		l = new Audio,
		h = new Audio,
